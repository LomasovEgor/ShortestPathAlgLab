...
class AutocompleteEntryListbox(ttk.Frame):
    ...
    def __init__(self, master=None, completevalues=[], allow_other_values=False,
        ...
        self.listbox__completevalues = completevalues
        self._completevalues = completevalues

        self.compare__completevalues = []
        for i in self._completevalues:
            self.compare__completevalues.append(i.lower())
        self.compare__completevalues += self._completevalues
        self._completevalues = self.compare__completevalues
        ...
        for c in self.listbox__completevalues:
    ...
    def _validate(self, action, modif, pos, prev_txt, new_txt):
        ...
        if action == "0":
            ...
            l = [i for i in self.compare__completevalues if i[:len(txt)] == txt]
            if l:
                i = self._completevalues.index(l[0])
                self.listbox.selection_clear(0, "end")
                self.listbox.selection_set(i)
                ...
                self.entry.insert(0, l[0].replace("\ ", " ").title())
...
class CorrectedAutocompleteEntryListbox(AutocompleteEntryListbox):
    def __init__(self, master=None, completevalues=[], allow_other_values=False,
                 autohidescrollbar=True, **kwargs):
        super().__init__(self, master=None, completevalues=[], allow_other_values=False,
                 autohidescrollbar=True, **kwargs)
        self.listbox__completevalues = completevalues
        self._completevalues = completevalues
